...
public class Defend_Gray extends CustomCard {
    ...
    public static final String ID = "theShooter:Defend_Gray";
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = ShooterMod.makePath(ShooterMod.DEFEND);
