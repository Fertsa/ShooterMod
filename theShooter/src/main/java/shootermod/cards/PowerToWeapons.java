...
public class PowerToWeapons extends CustomCard {
    ...
    public static final String ID = ("theShooter:PowerToWeapons");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = ShooterMod.makePath(ShooterMod.PTWEAPONS);
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new PowerWeaponsAction(p, m, this.magicNumber,
