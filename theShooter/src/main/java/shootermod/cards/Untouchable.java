...
public class Untouchable extends CustomCard {
    ...
    public static final String ID = "theShooter:Untouchable";
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = ShooterMod.makePath(ShooterMod.NOTOUCH);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new EvasionPower(p,p, this.magicNumber), this.magicNumber));
    }
