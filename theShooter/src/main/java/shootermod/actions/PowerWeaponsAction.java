...
import shootermod.powers.GainSTRPower;
import shootermod.powers.VelocityPower;

public class PowerWeaponsAction extends AbstractGameAction {
    ...
    public PowerWeaponsAction(final AbstractPlayer p, final AbstractMonster m,
        ...
        if (effect > 0) {
            for (int i = 0; i < effect; ++i) {
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this.p, this.p,
                        new GainSTRPower(this.p,this.p, this.magicNumber), this.magicNumber,
                        AttackEffect.NONE));
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this.p, this.p,
                        new GainSTRPower(this.p,this.p, this.magicNumber), this.magicNumber,
                        AttackEffect.NONE));
