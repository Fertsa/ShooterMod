...
public class PlaceholderPotion extends AbstractPotion {
    ...
    public static final String POTION_ID = ("theShooter:PlaceholderPotion");
    ...
    public PlaceholderPotion() {
        // The bottle shape and inside is detemined by potion size and color. The actual colors are the main ShooterMod.java
